...
const TV_GENRES = [
  { id: 0, label: "Tất Cả" },
  { id: 10759, label: "Hành Động & Phiêu Lưu" },
  { id: 16, label: "Hoạt Hình" },
  { id: 35, label: "Hài" },
  { id: 80, label: "Hình Sự" },
  { id: 99, label: "Tài Liệu" },
  { id: 18, label: "Chính Kịch" },
          ...
          >
            <div className="flex items-center gap-2 shrink-0">
              <Select value={String(activeGenre)} onValueChange={(val) => handleGenreChange(Number(val))}>
                <SelectTrigger className="w-[140px] rounded-full bg-transparent border-gray-200 dark:border-white/10 hover:bg-gray-100 dark:hover:bg-white/10 dark:text-white transition-colors text-blue-600 dark:text-blue-400 font-medium">
