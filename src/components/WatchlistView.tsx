    ...
    return (
      <div className="min-h-[60vh] flex flex-col items-center justify-center gap-6 text-center px-4">
        <div className="w-24 h-24 rounded-full bg-white/5 border border-white/10 flex items-center justify-center">
          <Bookmark className="size-10 text-white/30" />
        </div>
        <div>
  ...
  return (
    <div className="max-w-[1600px] mx-auto px-6 md:px-10 pb-16 space-y-8">
      <div className="flex items-center gap-3">
        <Bookmark className="size-6 text-white fill-white" />
        ...
        {items.map((item) => {
          ...
          return (
            <div key={`${item.type}-${item.id}`} className="group relative">
              <Link href={href}>
                <div className="relative aspect-[2/3] rounded-xl overflow-hidden bg-white/5 shadow-lg transition-all duration-300 group-hover:scale-[1.03] group-hover:shadow-2xl group-hover:shadow-black/60">
                  <Image
                ...
                <p className="mt-2.5 text-xs font-medium line-clamp-1 text-white group-hover:text-white/70 transition-colors">
                  {item.title}
                </p>
